 ...
 * @method static bool chatSendServerMessage(string $string)
 * @method static bool chatSendServerMessageToLanguage(array $array, string $string)
 * @method static bool chatSendServerMessageToId(string $string, int $int)
 * @method static bool chatSendServerMessageToLogin(string $string, string $string)
