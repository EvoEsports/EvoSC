...
class Exchange
{
    ...
    //const MANIAPLANET_MX_API_URL = 'https://tm.mania.exchange/api';
    const MANIAPLANET_MX_API_URL = 'https://api.mania.exchange/tm/maps'; //deprecated use above when available
